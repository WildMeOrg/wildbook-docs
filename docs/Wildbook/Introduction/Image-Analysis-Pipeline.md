...
![Image of 2 annotated gray wolves](https://images.squarespace-cdn.com/content/v1/52c62b4be4b0ca96fb3cfcba/1551800808966-70BYZ6SLYAYBON6S0E05/result_27.jpg){width="" height=""}*Resulting bounding boxes (Annotations) predicted by WBIA's detection pipeline after running a photo of two gray wolves.*

![Image of 3 annotated cheetahs](uploads/image.png-2212135358){width="" height=""}*Resulting bounding boxes (Annotations) predicted by WBIA's detection pipeline after running a photo of three cheetahs.*
...
![Different image analysis pipelines](uploads/image.png-2212135634){width="" height=""}*Visual pipeline showing how different species and body parts are detected, then Wildbook directs them to one or more appropriate algorithms to identify the individual.*
...
![](uploads/gradCAMBeluga.png){width="800" height=""}
...
![](https://www.researchgate.net/profile/Asia-Armstrong/publication/357287362/figure/fig1/AS:1156562747965440@1652757455202/The-proposed-system-learns-embeddings-for-images-from-the-database-The-embeddings-of-the.png){width=""}*New image of a Manta Ray compared against embeddings from the database*.
...
![Hotspotter applied to Plains Zebras](https://www.researchgate.net/publication/261342479/figure/fig1/AS:296747223011339@1447761459825/An-example-of-HotSpotter-The-ROI-is-placed-on-a-query-animal-in-this-case-a-foal-and.png){width="" height=""}
...
![Aerial image of a right whale with its callouses highlighted](https://deepsense.ai/wp-content/uploads/2016/01/w_0_bbox.jpg){width="" height=""}
...
![Mapping curvatures of tail flukes](https://d3i71xaburhd42.cloudfront.net/2ef4ea4237c0e63ea49fa7ace49a9a52a2772f7d/7-Figure7-1.png){width="" height=""}
...
![Mapped edges of a humpback tail fluke](https://www.flukebook.org/images/spermWhaleTrailingEdge.jpg){width="" height=""}
...
![Spot mapped Whale Shark](https://www.sharkbook.ai/images/whaleshark_lander.jpg){width="" height=""}*Spot mapping of a Whale Shark's unique body spots.*
...
![orca potential match results](https://i.ytimg.com/vi/caZ1rDacrXo/maxresdefault.jpg){width="" height=""}*Match results for an Orca based on the PIE algorithm using the scratch marks on its saddle patch.*
