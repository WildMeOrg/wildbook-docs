...
1. Make sure you are logged in to Wildbook. This ensures that any Encounter report you submit is assigned to you.
2. From your Wildbook's landing page, select **Report an Encounter** from the **Submit** menu.
3. Click to import or drag a photo to the Photos section and select one photo of one animal for your first Encounter. Wildbook can accept multiple photos of the same animal or even a photo of multiple animals.
4. Once you submit your photo, you must also submit the **Encounter Date**, **Encounter Location**, and **Species** as the minimum required fields. These required fields are indicated by the asterisk, but you can add additional information such as GPS coordinates and elevation.
5. If you're prompted to complete the Captcha before you submit your Encounter, you are not logged in to your account. Log in and try again.
6. Once you have finished entering your data, click **Submit Encounter**. You will see a confirmation page for your submission.
7. Click the **View Encounter** link on the confirmation page to visit your new Encounter.
    ![quickstart encounter](assets/images/wb-getting-started-encounter.png)
...
See [Bulk Import](data/bulk-import-beta.md) for more information on how to convert your data to an spreadsheet-based format for import into Wildbook.
